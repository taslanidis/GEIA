...
do
    ...
    do
        ...
        sbatch --job-name "eval_geia_${DATASET}_${EMBED_MODEL}_GEIA" ./scripts/jobs/geia_train_eval.job --model_dir random_gpt2_medium --dataset ${DATASET} --data_type test --embed_model ${EMBED_MODEL}
    done
done
